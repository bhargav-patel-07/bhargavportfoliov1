    ...
    <div className="flex flex-col justify-between bg-white/10 border border-transparent rounded-xl p-6 shadow transition-all duration-200 hover:scale-105 hover:border-purple-500 cursor-pointer w-full max-w-xs min-h-[350px] max-h-[350px] mx-auto">
      ...
      <div className="flex justify-between w-full gap-2">
        <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" className="w-1/2">
          <button className="w-full  text-white px-2 py-2 rounded-lg hover:bg-purple-600 transition text-sm whitespace-nowrap border border-white/30">
            View Project
          </button>
        </a>
        <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className="w-1/2">
          <button className="w-full  text-white px-2 py-2 rounded-lg hover:bg-gray-700 transition text-sm whitespace-nowrap border border-white/30">
            GitHub
          </button>
        </a>
      </div>
